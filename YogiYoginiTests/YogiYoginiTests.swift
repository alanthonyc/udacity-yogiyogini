...
class YogiYoginiTests: XCTestCase
{
    ...
    func testTimeModuleSeconds()
    {
        ...
        XCTAssertEqual(sevenSecs.inMinutes, 0.0, "(min): \(sevenSecs.inMinutes)")
        XCTAssertEqual(sevenSecs.inHours, 0.0, "(hrs): \(sevenSecs.inHours)")
        ...
        XCTAssertEqual(fortyTwoSecs.inMinutes, 0.0, "(min): \(fortyTwoSecs.inMinutes)")
        XCTAssertEqual(fortyTwoSecs.inHours, 0.0, "(hrs): \(fortyTwoSecs.inHours)")
        ...
        XCTAssertEqual(sixtySecs.inMinutes, 1.0, "(min): \(sixtySecs.inMinutes)")
        XCTAssertEqual(sixtySecs.inHours, 0.0, "(hrs): \(sixtySecs.inHours)")
        ...
        XCTAssertEqual(seventyThreeSecs.inMinutes, 1.0, "(min): \(seventyThreeSecs.inMinutes)")
        XCTAssertEqual(seventyThreeSecs.inHours, 0.0, "(hrs): \(seventyThreeSecs.inHours)")
        ...
        XCTAssertEqual(threeAndTwentyTwoSecs.inMinutes, 3.0, "(min): \(threeAndTwentyTwoSecs.inMinutes)")
        XCTAssertEqual(threeAndTwentyTwoSecs.inHours, 0.0, "(hrs): \(threeAndTwentyTwoSecs.inHours)")
        ...
        XCTAssertEqual(threeHours3MinsAnd22Secs.inMinutes, 183.0, "(min): \(threeHours3MinsAnd22Secs.inMinutes)")
        XCTAssertEqual(threeHours3MinsAnd22Secs.inHours, 3.0, "(hrs): \(threeHours3MinsAnd22Secs.inHours)")
    ...
    func testTimeModuleMinutes()
    {
        ...
        XCTAssertEqual(mins1.inMinutes, 1.0, "(min): \(mins1.inMinutes)")
        XCTAssertEqual(mins1.inHours, 0.0, "(hrs): \(mins1.inHours)")
        ...
        XCTAssertEqual(mins10.inMinutes, 10.0, "(min): \(mins10.inMinutes)")
        XCTAssertEqual(mins10.inHours, 0.0, "(hrs): \(mins10.inHours)")
        ...
        XCTAssertEqual(mins60.inMinutes, 60.0, "(min): \(mins60.inMinutes)")
        XCTAssertEqual(mins60.inHours, 1.0, "(hrs): \(mins60.inHours)")
        ...
        let mins84 = Minutes(value:(mins60.asDouble + 24.minutes.asDouble))
        ...
        XCTAssertEqual(mins84.inMinutes, 84.0, "(min): \(mins84.inMinutes)")
        XCTAssertEqual(mins84.inHours, 1.0, "(hrs): \(mins84.inHours)")
        ...
        XCTAssertEqual(mins93and12.inMinutes, 93.0, "(min): \(mins93and12.inMinutes)")
        XCTAssertEqual(mins93and12.inHours, 1.0, "(hrs): \(mins93and12.inHours)")
    ...
    func testTimeModuleHours()
    {
        ...
        XCTAssertEqual(hours1.inMinutes, 60.0, "(min): \(hours1.inMinutes)")
        XCTAssertEqual(hours1.inHours, 1.0, "(hrs): \(hours1.inHours)")
        ...
        let hours2 = hours1.multipliedBy(2)
        ...
        XCTAssertEqual(hours2.inMinutes, 120.0, "(min): \(hours2.inMinutes)")
        XCTAssertEqual(hours2.inHours, 2.0, "(hrs): \(hours2.inHours)")
    ...
    func testTimeModuleArithmetic()
    {
        let h = 2.hours
        print("H: \(h) --- \(h.inMinutes) --- \(h.inSeconds) --- \(h.asDouble)")
        let m = 30.minutes
        print("M: \(m) --- \(m.inMinutes) --- \(m.inSeconds) --- \(m.asDouble)")
        let dur = 2.hours + 30.minutes
        print("dur: \(dur)")
        let (x,y,z) = (2.hours + 30.minutes).components()
        print("\(x.paddedString):\(y.paddedString):\(z.paddedString)")
    }
